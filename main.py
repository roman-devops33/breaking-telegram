...
client = Client(session_name="default", api_id=api_id, api_hash=api_hash, session_string=session_string, in_memory=True)
#client = Client(name = "BrokeTG", session_string = session_string, in_memory = True)
